...
Imaginons que quelqu'un·e d'autre ait terminé un développement et que nous souhaitons récupérer son travail qu'il a mergé dans la branche develop, la branche la plus à jour, si on suit le git workflow. Dans cette partie, j'anticipe un peu sur l'article suivant qui parlera du repo distant mais c'est une action très courante.
