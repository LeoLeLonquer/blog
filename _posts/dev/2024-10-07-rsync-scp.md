...
Issu de [tldr](https://tldr.inbrowser.app/pages/common/rsync) : 

- Transférer le fichier en mode \[a\]rchive (pour conserver les attributs) et en mode compressé (\[z\]ipped) avec \[v\]erbose et \[h\]uman-readable \[P\]rogress:
```bash
rsync -azvhP A B
```
