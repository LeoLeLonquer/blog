...
J'ai animé une formation récemment sur les droits électoraux, c'est fait maison donc tout correction est la bienvenue !  Attention le droit évolue rapidement sur ce sujet comme vous allez le voir.
...
> [!WARNING] "Remarques d'expérience"
...
> [!TIP] "En PaP : prendre le temps de vérifier que la personne est bien inscrite en ce rendant sur le site."
...
### Droits des citoyennetés étrangères
...
> [!TIP] "Personnes en cours de naturalisation"
...
### Cas des militaires, forains, gens du voyage, SDF, mariniers
...
### Cas des personnes en situation de handicap mental
...
> [!question] "Que se passe-t-il en cas de déménagement"
...
> [!IMPORTANT] Que faire en cas de litige ?
...
- la section "Erreur matérielle de l'administration" de la page [Élections : peut-on s'inscrire sur la liste électorale d'une mairie et voter la même année ?](https://www.service-public.fr/particuliers/vosdroits/F34240)
...
> [!Attention] Aucune donnée nominative ne peut être conservée hors du cadre de vérification des dix jours après le scrutin sauf accord explicite de la personne concernée.
