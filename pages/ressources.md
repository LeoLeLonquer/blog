...
- [Time Calculator - Multiply, Divide Time](https://www.calculatorsoup.com/calculators/time/time-calculator.php)
- [Unix Timestamp Converter](https://www.epochconverter.com/)
- [Crontab.guru](https://crontab.guru/#40_2,10,14_*_*_*)
<!--more-->
...
- [Diagon: ASCII art diagram generator](https://arthursonzogni.com/Diagon/#GraphPlanar)
...
- [Apache Oozie Workflow Visualizer](https://fponzi.me/ApacheOozieWorkflowVisualizer/)
- [Hortonworks Sandbox with HDP 3.0](http://localhost:1080/splash.html)
- [Services libres en ligne](https://entraide.chatons.org/fr/)
- [Framatalk - Visioconférence](https://framatalk.org/accueil/fr/)
- [pad.infini](https://pad.infini.fr/)
...
- [Rust Command-Line Tools](https://zaiste.net/posts/shell-commands-rust/)
- [Apache DataFu](https://datafu.apache.org/)
- [DataSketches](https://datasketches.apache.org/)
- [ksqlDB - Kafka DB for stream processing applications](https://github.com/confluentinc/ksql)
...
- [Ian Whitestone](https://ianwhitestone.work/)
- [Ippon](https://blog.ippon.fr/tag/data/)
- [Philipp Brunenberg](https://blog.philipp-brunenberg.de/index.html)
- [Brendan Gregg's Homepage](https://brendangregg.com/)
- [Supergloo - Resources for Data Engineers and Data Architects](https://supergloo.com/)
- [UN Big Data](https://unstats.un.org/bigdata/)
- [Nivdul](https://nivdul.wordpress.com/)
- [Learn Data Engineering](https://learndataengineering.com/)
- [IP Girl](https://www.ipgirl.com/)

### Cheatsheets

- [hdfs-commands-cheatsheet.pdf](https://images.linoxide.com/hadoop-hdfs-commands-cheatsheet.pdf)
- [ps aux - STAT column values](https://askubuntu.com/questions/360252/what-do-the-stat-column-values-in-ps-mean)
- [WebEX Markdown Syntax](https://sourceforge.net/p/webex/wiki/markdown_syntax/)
...
- [Hive cmds](https://intellipaat.com/mediaFiles/2019/02/Hive-Cheat-Sheet.pdf)
- [Pandas CheatSheet](https://pandas.pydata.org/Pandas_Cheat_Sheet.pdf)
- [SQL Cheat Sheet](https://www.sqltutorial.org/sql-cheat-sheet/)
- [Bash scripting cheatsheet](https://devhints.io/bash)
- [Shell Magic - The Ultimate Bash Cheatsheet!](https://shellmagic.xyz/)
- [Bash Redirections Cheat Sheet](https://catonmat.net/ftp/bash-redirections-cheat-sheet.pdf)
- [systemd cheatsheet](https://access.redhat.com/sites/default/files/attachments/12052018_systemd_6.pdf)
- [Scala pour Apache Spark - Cheatsheet](https://blog.goovy.io/apache-spark-scala-cheatsheet/)
- [Markdown cheat sheet](https://www.pinterest.fr/pin/28217935144203210/)
- [Tmux Cheat Sheet](https://tmuxcheatsheet.com/)
- [python-pandas-cheatsheets.pdf](https://www.utc.fr/~jlaforet/Suppl/python-cheatsheets.pdf)
- [R-cheat-sheet.pdf](https://iqss.github.io/dss-workshops/R/Rintro/base-r-cheat-sheet.pdf)
- [GGplot2](https://thinkr.fr/pdf/ggplot2-french-cheatsheet.pdf)
- [RStudio Cheatsheets - RStudio](https://www.rstudio.com/resources/cheatsheets/)
- [excel-cheat-sheet.pdf](https://www.customguide.com/cheat-sheet/excel-cheat-sheet.pdf)
- [Distribution Cheatsheet](https://www.itl.nist.gov/div898/handbook/eda/section3/eda366.htm)
